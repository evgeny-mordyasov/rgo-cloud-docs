...
import rgo.cloud.docs.db.storage.repository.natural.PostgresLanguageRepository;
import rgo.cloud.docs.db.storage.repository.natural.PostgresClassificationRepository;
import rgo.cloud.docs.db.storage.repository.natural.PostgresDocumentRepository;
import rgo.cloud.docs.db.storage.repository.natural.PostgresTranslationRepository;
import rgo.cloud.docs.db.storage.repository.natural.PostgresReadingDocumentRepository;
